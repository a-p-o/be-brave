...
public class SettingsActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set default values
        PreferenceManager.setDefaultValues(this, R.xml.pref_security, false);
    }
...
//        loadHeadersFromResource(R.xml.pref_headers, target);
    ...
    /**
     * This fragment shows security preferences only.
    ...
    public static class SecurityPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("pref_pin"));
        }
    }
}
